        ...
        return __generator(this, function (_k) {
          switch (_k.label) {
            ...
            case 1:
              ...
              if (!(data[5] === 0)) return [3 /*break*/, 2]; // 实时的重量数据
            ...
            case 2:
              if (!(data[5] === 1)) return [3 /*break*/, 4]; // 电阻测量完毕
            ...
            case 4:
              if (!(data[5] === 3)) return [3 /*break*/, 5]; // 身高实时数据
            ...
            case 5:
              if (!(data[5] === 4)) return [3 /*break*/, 8]; // 身高测量结果
            ...
            case 12:
              this.log('接收到0x14命令');
              if (!(this.operation.action === QNBleAction.SET_WIFI)) return [3 /*break*/, 14]; // 通知秤准备配网
            ...
            case 18:
              this.log('接收到0x63命令');
              if (!(this.currentCmdNo < this.ssidCmdData.length)) return [3 /*break*/, 20]; // ssid还没发送完
            ...
            case 25:
              this.log('接收到0x67命令');
              if (!(this.currentCmdNo < this.pwdCmdData.length)) return [3 /*break*/, 27]; // wifi密码还没发送完
            ...
            case 31:
              this.log('接收到0x6B命令');
              if (!(this.currentCmdNo < this.dataServerUrlData.length)) return [3 /*break*/, 33]; // 数据服务器URL还没发送完
            ...
            case 38:
              this.log('接收到0x71命令');
              if (!(this.currentCmdNo < this.otaServerUrlData.length)) return [3 /*break*/, 40]; // OTA服务器URL还没发送完
        ...
        return __generator(this, function (_h) {
          switch (_h.label) {
            ...
            case 6:
              ...
              if (!(this.currentCmdNo < this.ssidCmdData.length)) return [3 /*break*/, 8]; // ssid还没发送完
            ...
            case 16:
              this.currentCmdNo = data[2];
              if (!(this.currentCmdNo < this.pwdCmdData.length)) return [3 /*break*/, 18]; // wifi密码还没发送完
            ...
            case 24:
              this.currentCmdNo = data[2];
              if (!(this.currentCmdNo < this.dataServerUrlData.length)) return [3 /*break*/, 26]; // 数据服务器URL还没发送完
            ...
            case 32:
              this.currentCmdNo = data[2];
              if (!(this.currentCmdNo < this.otaServerUrlData.length)) return [3 /*break*/, 34]; // OTA服务器URL还没发送完
        ...
        return __generator(this, function (_h) {
          switch (_h.label) {
            ...
            case 2:
              ...
              if (!(this.action === QNBleAction.SET_WIFI)) return [3 /*break*/, 4]; // 通知秤准备配网
            ...
            case 9:
              if (!(this.currentCmdNo < this.ssidCmdData.length)) return [3 /*break*/, 11]; // ssid还没发送完
            ...
            case 23:
              if (!(this.currentCmdNo < this.dataServerUrlData.length)) return [3 /*break*/, 25]; // 数据服务器URL还没发送完
            ...
            case 30:
              if (!(this.currentCmdNo < this.otaServerUrlData.length)) return [3 /*break*/, 32]; // OTA服务器URL还没发送完
            ...
            case 35:
              ...
              if (!(data[2] === 0)) return [3 /*break*/, 37]; // 正在检测
        ...
        return __generator(this, function (_q) {
          switch (_q.label) {
            ...
            case 27:
              ...
              if (!(this.currentSetWifiCmdNo < this.ssidCmdData.length)) return [3 /*break*/, 29]; // ssid还没发送完
            ...
            case 36:
              this.currentSetWifiCmdNo = data[2];
              if (!(this.currentSetWifiCmdNo < this.pwdCmdData.length)) return [3 /*break*/, 38]; // wifi密码还没发送完
            ...
            case 44:
              ...
              if (!(this.currentSetWifiCmdNo < this.dataServerUrlData.length))
                return [3 /*break*/, 46]; // 数据服务器URL还没发送完
            ...
            case 52:
              ...
              if (!(this.currentSetWifiCmdNo < this.otaServerUrlData.length))
                return [3 /*break*/, 54]; // ota服务器URL还没发送完
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              this.log('mdata', mdata);
              if (!this.isStoreData) return [3 /*break*/, 1]; // 这里处理存储数据的逻辑
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 4:
              if (!(this.bleDevice.type === QNBleDeviceType.HEIGHTWEIGHT)) return [3 /*break*/, 6]; // 身高体重秤 CP30B
            ...
            case 6:
              if (!(this.bleDevice.type === QNBleDeviceType.HEIGHTWEIGHT_SINGLE_BLE))
                return [3 /*break*/, 8]; // 身高体重单蓝牙秤 CP30A
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!this.config.useSdk) return [3 /*break*/, 3]; // 使用SDK配置，请求获取SDK的配置信息
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!this.bleScannerState) return [3 /*break*/, 4]; // 已经启动了蓝牙扫描，则尝试停止扫描后，再启动扫描
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!(bleDevice.transferType === QNBleTransferType.BLE)) return [3 /*break*/, 2]; // 在这里卸载协议吧，有时并不一定会收到 onDisconnectd 回调
              // this.unmountProtocol(bleDevice.deviceId);
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              if (!(!available && res.bleEnableState === 'uninit')) return [3 /*break*/, 4]; // 定位及蓝牙打开后初始化蓝牙
