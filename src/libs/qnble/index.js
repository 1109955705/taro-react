...
(function (QNBleErrorType) {
  ...
  QNBleErrorType["STOP_DISCOVERY_CONNECT_BROADCAST_DEVICE"] = "STOP_DISCOVERY_CONNECT_BROADCAST_DEVICE";
...
var QNBleErrorDesc = (_a = {}, _a[QNBleErrorType.SUCCESS] = {
...
var QNBleEventNames = ['bluetooth_enable_change', 'start_discovery_device', 'stop_discovery_device', 'ble_device_found', 'connected', 'disconnected', 'connect_overtime']; // 设备事件名
...
function (_super) {
  ...
  QNScaleBiz.prototype.fetchScaleData = function (scaleData) {
    ...
    (_b = (_a = this.listener).onStartFetchScaleData) === null || _b === void 0 ? void 0 : _b.call(_a);
    return this.bleNative.sendHttpRequest({
      data: params,
      method: 'POST',
      ...
      if (data.code !== '200') {
        ...
        (_b = (_a = _this.listener).onFetchScaleDataFail) === null || _b === void 0 ? void 0 : _b.call(_a, err);
        throw err;
      }
...
function (_super) {
  ...
  QNBleProtocol.prototype.onGetData = function (payload) {
    ...
    this.log("[\u6536\u5230] serviceId: " + payload.serviceId + "; characteristicId: " + payload.characteristicId + "; data: " + hexArray);
...
function (_super) {
  ...
  HeightWeightScaleProtocol.prototype.sendWifiSsid = function () {
    this.log('ssidCmdData数据', this.ssidCmdData, 'currentCmdNo', this.currentCmdNo);
  ...
  HeightWeightScaleProtocol.prototype.sendDataServerUrl = function () {
    ...
    this.currentCmdNo += 1;
    this.log("\u53D1\u9001\u7B2C " + this.currentCmdNo + " \u5305 DATA\u670D\u52A1\u5668 \u6570\u636E");
    return this.writeData({
  ...
  HeightWeightScaleProtocol.prototype.sendOtaServerUrl = function () {
    ...
    this.currentCmdNo += 1;
    this.log("\u53D1\u9001\u7B2C " + this.currentCmdNo + " \u5305 OTA\u670D\u52A1\u5668 \u6570\u636E");
    return this.writeData({
      ...
      return __generator(this, function (_f) {
        switch (_f.label) {
          ...
          case 4:
            ...
            /*break*/
            , 8];
            if (!isHeartRateScale(scaleType)) return [3
            /*break*/
            , 5];
            return [3
            /*break*/
...
function () {
  ...
  OneToMultiBroadcastScaleProfile.prototype.buildTargetDevice = function (nativeDevice) {
    ...
    var manufacturer = nativeDevice.manufacturer;
    var macs = [number2hex(manufacturer[2]), number2hex(manufacturer[3]), number2hex(manufacturer[4]), number2hex(manufacturer[5]), number2hex(manufacturer[6]), number2hex(manufacturer[7])];
    return {
      isScreenOn: true,
...
function (_super) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            data = payload.data;
            weight = Number.parseFloat(this.scaleBizImp.decodeWeight(data[10], data[9]).toFixed(2));
            status = data[8];
            isSteady = (status & 0x1) === 1;
            if (!!isSteady) return [3
            /*break*/
            , 1];
            (_b = (_a = this.listener).onGetUnsteadyWeight) === null || _b === void 0 ? void 0 : _b.call(_a, {
              weight: weight
  ...
  OneToMultiBroadcastScaleProtocol.prototype.buildAdvertisingData = function (data) {
    ...
    return [0xFE, 0xFE, mac6, mac5, mac4, mac3, mac2, mac1, modelIdH, modelIdL, unitByte, 0, 0, 0, 0, 0];
  };
...
function () {
  ...
  OneToOneBroadcastScaleProfile.prototype.buildTargetDevice = function (nativeDevice) {
    ...
    var manufacturer = nativeDevice.manufacturer;
    var macs = [number2hex(manufacturer[4]), number2hex(manufacturer[5]), number2hex(manufacturer[6]), number2hex(manufacturer[7]), number2hex(manufacturer[8]), number2hex(manufacturer[9])];
    var appMacs = [number2hex(manufacturer[14]), number2hex(manufacturer[15]), number2hex(manufacturer[16])];
    return {
      isScreenOn: true,
...
function (_super) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            data = payload.data;
            weight = Number.parseFloat(this.scaleBizImp.decodeWeight(data[20], data[19]).toFixed(2));
            status = data[17];
            isSteady = (status & 0x1) === 1;
  ...
  OneToOneBroadcastScaleProtocol.prototype.buildAdvertisingData = function (data) {
    ...
    if (isStore) {
      ...
      this.log("\u63A5\u6536\u5B58\u50A8\u6570\u636E,\u603B\u5171 " + storeTotalCount + " \u5F53\u524D " + dataTypeByte);
    } else {
    ...
    return [mac6, mac5, mac4, mac3, mac2, mac1, modelIdH, modelIdL, unitByte, this.appMac[2], this.appMac[1], this.appMac[0], time4, time3, time2, time1];
  };
...
function () {
  ...
  WspDualScalebleProfile.prototype.isTargetDevice = function (nativeDevice) {
    ...
    if ((bleName === 'QN-Scale' || /^Hi-/.test(bleName)) && nativeDevice.manufacturer.length >= 19) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            this.log('使能自定义服务');
            console.log('this.operation', this.operation); // 使能人体成分组成服务

            return [4
            /*yield*/
            , this.bleNative.enableNotify(this.bleDevice.deviceId, UUID_BODY_SERVICES, UUID_USER_DEFINED_READ)];
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , this.bleNative.enableNotify(this.bleDevice.deviceId, UUID_USER_SERVICES, UUID_USER_WRITE_READ)];

          case 3:
            _b.sent();

            _a = this.operation, isRegisterUser = _a.isRegisterUser, deletedUserIndexArr = _a.deletedUserIndexArr;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.bleNative.readBleCharacteristicValue(this.bleDevice.deviceId, UUID_WEIGHT_SERVICES, UUID_WEIGHT_READ)];
...
function () {
  ...
  ShareCLScaleProfile.prototype.buildTargetDevice = function (nativeDevice) {
    ...
    var manufacturer = nativeDevice.manufacturer;
    var macs = [number2hex(manufacturer[14]), number2hex(manufacturer[13]), number2hex(manufacturer[12]), number2hex(manufacturer[11]), number2hex(manufacturer[10]), number2hex(manufacturer[9])];
    var modelIds = [number2hex(manufacturer[4]), number2hex(manufacturer[5])];
    var sns = [number2hex(manufacturer[6]), number2hex(manufacturer[7]), number2hex(manufacturer[8])];
    return {
...
function (_super) {
      ...
      return __generator(this, function (_h) {
        switch (_h.label) {
          ...
          case 1:
            ...
            /*yield*/
            , this.writeData({
              cmdData: [0x13, 0x4, // Status：1-正常回复，2-生产测试回复（由于3.5寸共享称存在蓝牙配网的可能，保留对原有配网协议的兼容）
              0x01]
            })];
          ...
          case 2:
            ...
            if (!(this.action === QNBleAction.SET_WIFI)) return [3
            /*break*/
            , 4]; // 通知秤准备配网
          ...
          case 6:
            // data[2]
            // 1 进入休眠
            (_a = this.sleepScaleCallback) === null || _a === void 0 ? void 0 : _a.call(this, {
              errCode: data[2]
            }, payload, this);
            return [3
            /*break*/
          ...
          case 32:
            ...
            (_c = (_b = this.listener).onSetWifiSuccess) === null || _c === void 0 ? void 0 : _c.call(_b);
            (_d = this.setWifiCallback) === null || _d === void 0 ? void 0 : _d.call(this, {
              errCode: 1
            }, payload, this);
            _h.label = 33;
          ...
          case 35:
            ...
            (_e = this.checkWifiStatusCallback) === null || _e === void 0 ? void 0 : _e.call(this, retV, payload, this);
            if (!(data[2] === 0)) return [3
            /*break*/
            , 37]; // 正在检测
          ...
          case 38:
            ...
            // 1 成功
            // 0 失败
            (_f = this.syncDataCallback) === null || _f === void 0 ? void 0 : _f.call(this, {
              errCode: data[2]
            }, payload, this);
            return [3
            /*break*/
      ...
      return __generator(this, function (_g) {
        switch (_g.label) {
          case 0:
            ...
            _a = __assign(__assign({}, this.operation), operaton || {}), _b = _a.wifiSsid, wifiSsid = _b === void 0 ? '' : _b, _c = _a.wifiPwd, wifiPwd = _c === void 0 ? '' : _c, _d = _a.dataServerUrl, dataServerUrl = _d === void 0 ? 'http://wifi.yolanda.hk:80/wifi_api/aios?code=' : _d, _e = _a.otaServerUrl, otaServerUrl = _e === void 0 ? 'https://ota.yolanda.hk' : _e, _f = _a.encryptKey, encryptKey = _f === void 0 ? '' : _f;
            this.log('wifiSsid', wifiSsid, 'wifiPwd', wifiPwd);
  ...
  ShareCLScaleProtocol.prototype.syncData = function (payload, callback) {
    return __awaiter(this, void 0, void 0, function () {
      var chargeTimeH, chargeTimeL, unChargeTimeH, unChargeTimeL, _a, offScreenStartTime, offScreenEndTime, offScreenStartHour, offScreenStartMin, offScreenEndHour, offScreenEndtMin;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            _a = __read(payload.offScreenTimeDuration, 2), offScreenStartTime = _a[0], offScreenEndTime = _a[1];
          ...
          case 1:
            ...
            /*return*/
            , this.writeData({
              cmdData: [0x80, 0x04, payload.fatSwitch, chargeTimeH, chargeTimeL, unChargeTimeH, unChargeTimeL, offScreenStartHour, offScreenStartMin, offScreenEndHour, offScreenEndtMin, payload.voice]
            })];
        }
      });
    });
...
function (_super) {
      ...
      return __generator(this, function (_c) {
        switch (payload.data[0]) {
          case 0x65:
            ...
            // 1 成功
            // 0 失败
            (_a = this.syncDataCallback) === null || _a === void 0 ? void 0 : _a.call(this, {
              errCode: payload.data[2]
            }, payload, this);
            break;

          case 0x68:
            (_b = this.rebootCallback) === null || _b === void 0 ? void 0 : _b.call(this, {
              errCode: payload.data[2]
            }, payload, this);
            break;
        }
  ...
  ShareScaleProtocol.prototype.syncData = function (payload, callback) {
    ...
    return this.writeData({
      cmdData: [0x64, 0xA, payload.voice, payload.lightSwitch, lightStartTimeHour, lightStartTimeMin, lightStartTimeSec, lightContinueTimeHour, lightContinueTimeMin]
    });
  };
...
function parseMeasureInfo(data) {
  ...
  var minute = data[7];
  var second = data[8];
  var dateTimeString = formatTime(new Date(year, month - 1, day, hour, minute, second), 'YYYY-MM-DD HH:mm:ss'); // 收缩压
...
function (_super) {
      ...
      return __generator(this, function (_q) {
        switch (_q.label) {
          ...
          case 6:
            ...
            , 14];
            retValue = data[2];
            (_b = (_a = this.listener).onGetDeviceSetStatus) === null || _b === void 0 ? void 0 : _b.call(_a, retValue);
  ...
  SphygmomanometerProtocol.prototype.getDeviceInfo = function (data) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      var deviceInfo, chargeType, supportChangeLanguage, standardType, deviceStatus, chargeStatus, unit, language, volume, historyCount, modelId, softwareVersion, bleVersion, bleProtocolVersion, nowDate, year, month, day, hour, minute, second, timeZoneOffset, timeZone;
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            deviceInfo = data[2];
            ...
            this.log('同步时间', year, month, day, hour, minute, second, timeZone);
            return [4
            /*yield*/
            , this.writeData({
              cmdData: [0x13, 13, year, month, day, hour, minute, second, // 单位切换 0xff：不切换单位；00：mmgh；01：kpa
      ...
      return __generator(this, function (_h) {
        switch (_h.label) {
          case 0:
            ...
            data.splice(2, 1);
            measureCmdData = data;
            this.log('doSyncCurrentData', 'measureStatus', measureStatus, 'measureCmdData', measureCmdData);
          ...
          case 1:
            (_b = (_a = this.listener).onMeasuring) === null || _b === void 0 ? void 0 : _b.call(_a, measureInfo);
            return [3
            /*break*/
            , 7];
          ...
          case 2:
            ...
            (_d = (_c = this.listener).onMeasureSuccess) === null || _d === void 0 ? void 0 : _d.call(_c, measureInfo);
            return [4
            /*yield*/
            , this.writeData({
              cmdData: [0x1F, 4, 0x10]
          ...
          case 4:
            (_f = (_e = this.listener).onMeasureFail) === null || _f === void 0 ? void 0 : _f.call(_e, measureInfo);
            return [4
            /*yield*/
            , this.writeData({
              cmdData: [0x1F, 4, 0x10]
        ...
        switch (_c.label) {
          case 0:
            ...
            if (!equal(measureInfo, this.lastReceivedHistoryData)) {
              (_b = (_a = this.listener).onGetHistoryData) === null || _b === void 0 ? void 0 : _b.call(_a, measureInfo);
              this.lastReceivedHistoryData = measureInfo;
            } else {
              this.log('doSyncHistoryData', '收到与上一条重复的数据', 'lastReceivedHistoryData', this.lastReceivedHistoryData);
            }
...
function (_super) {
  ...
  BleKitchenScaleProtocol.prototype.onGetScaleData = function (data) {
    return __awaiter(this, void 0, void 0, function () {
      var scaleMessage, isPeeled, type, overWeight, isSteady, precision, range, weightUnit, getWeight, weight, scaleData;
      return __generator(this, function (_a) {
        scaleMessage = data[8];
...
function () {
  ...
  BroadcastKitchenScaleProtocolProfile.prototype.buildTargetDevice = function (nativeDevice) {
    ...
    var manufacturer = nativeDevice.manufacturer;
    var macs = [number2hex(manufacturer[9]), number2hex(manufacturer[10]), number2hex(manufacturer[11]), number2hex(manufacturer[12]), number2hex(manufacturer[13]), number2hex(manufacturer[14])];
    return {
...
function (_super) {
  ...
  BroadcastKitchenScaleProtocol.prototype.decode = function (payload) {
    return __awaiter(this, void 0, void 0, function () {
      var data, weight, scaleMessage, isSteady, weightUnitIndex, overWeight, type, isPeeled, weightUnit, scaleData;
      return __generator(this, function (_a) {
        data = payload.data;
...
var UUID_TIME_SERVICES$1 = '00001805-0000-1000-8000-00805F9B34FB'; // 使能当前时间服务
...
var UUID_USER_SERVICES$1 = '0000181C-0000-1000-8000-00805F9B34FB'; // 使能用户数据服务,注册、访问、删除

var UUID_USER_WRITE_READ$1 = '00002A9F-0000-1000-8000-00805F9B34FB'; // 更新性别指令

var UUID_USER_GRAND_UPDATE$1 = '00002A8C-0000-1000-8000-00805F9B34FB'; // 更新身高

var UUID_USER_HEIGHT_UPDATE$1 = '00002A8E-0000-1000-8000-00805F9B34FB'; // 更新出生日期

var UUID_USER_BIRTHDAY_UPDATE$1 = '00002A85-0000-1000-8000-00805F9B34FB'; // 更新年龄

var UUID_USER_AGE_UPDATE$1 = '00002A80-0000-1000-8000-00805F9B34FB'; // 设置用户算法
...
var UUID_WEIGHT_SERVICES$1 = '0000181D-0000-1000-8000-00805F9B34FB'; // 读取体重特征（支持功能）

var UUID_WEIGHT_READ$1 = '00002A9E-0000-1000-8000-00805F9B34FB'; // 使能体重服务
...
var UUID_BODY_SERVICES$1 = '0000181B-0000-1000-8000-00805F9B34FB'; // 使能读取人体特征服务(支持功能)

var UUID_BODY_READ$1 = '00002A9B-0000-1000-8000-00805F9B34FB'; // 使能人体成分组成
...
var UUID_CUSTOMIZE_SERVICES = '0000FFE0-0000-1000-8000-00805F9B34FB'; // 自定义协议 （写入单位，删除用户等）

var UUID_USER_DEFINED_WRITE$1 = '0000FFE2-0000-1000-8000-00805F9B34FB'; // 自定义协议 （读取单位，读取删除结果等）
...
function (_super) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 11:
            ...
            return [4
            /*yield*/
            , this.bleNative.enableNotify(this.bleDevice.deviceId, UUID_TIME_SERVICES$1, UUID_TIME_WRITE_READ$1)];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , this.bleNative.enableNotify(this.bleDevice.deviceId, UUID_CUSTOMIZE_SERVICES, UUID_USER_DEFINED_READ$1)];
          ...
          case 11:
            ...
            return [4
            /*yield*/
            , this.bleNative.enableNotify(this.bleDevice.deviceId, UUID_USER_SERVICES$1, UUID_USER_WRITE_READ$1)];
  ...
  WspDualScaleProtocol.prototype.doPrepareSetWifi = function (payload) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_g) {
        switch (_g.label) {
          case 0:
            _a = __assign(__assign({}, this.operation), payload), _b = _a.wifiSsid, wifiSsid = _b === void 0 ? '' : _b, _c = _a.wifiPwd, wifiPwd = _c === void 0 ? '' : _c, _d = _a.dataServerUrl, dataServerUrl = _d === void 0 ? '' : _d, _e = _a.otaServerUrl, otaServerUrl = _e === void 0 ? 'https://ota.yolanda.hk' : _e, _f = _a.encryptKey, encryptKey = _f === void 0 ? 'yolandakitnewhdr' : _f;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_r) {
        switch (_r.label) {
          ...
          case 11:
            {
              this.log('进入 UUID_WEIGHT_NOTIFY'); // 清空
  ...
  WspDualScaleProtocol.prototype.buildBodyData = function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      var data, year, month, dayOfMonth, hour, minute, second, time, realMassRatio, bodyfat, bmr, muscle, muscleMass, lbm, water, resistance50, resistance500, bone, visfat, subfat, protein, bodyAge, heartRate, score, bodyShape, heartIndex, resistance20_left_leg, resistance100_left_leg, resistance20_right_leg, resistance100_right_leg, resistance20_left_arm, resistance100_left_arm, resistance20_right_arm, resistance100_right_arm, resistance20_trunk, resistance100_trunk, measureData, mdata, err_1;
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            data = __spread(this.bodyByteDataArr[0], this.bodyByteDataArr[1], this.bodyByteDataArr[2]);
            this.log('buildBodyData', 'data', data);
            ...
            resistance20_left_leg = Number.parseFloat((decodeInteger(data[40], data[39]) * 0.1).toFixed(2));
            resistance100_left_leg = Number.parseFloat((decodeInteger(data[42], data[41]) * 0.1).toFixed(2));
            resistance20_right_leg = Number.parseFloat((decodeInteger(data[44], data[43]) * 0.1).toFixed(2));
            resistance100_right_leg = Number.parseFloat((decodeInteger(data[46], data[45]) * 0.1).toFixed(2));
            resistance20_left_arm = Number.parseFloat((decodeInteger(data[48], data[47]) * 0.1).toFixed(2));
            resistance100_left_arm = Number.parseFloat((decodeInteger(data[50], data[49]) * 0.1).toFixed(2));
            resistance20_right_arm = Number.parseFloat((decodeInteger(data[52], data[51]) * 0.1).toFixed(2));
            resistance100_right_arm = Number.parseFloat((decodeInteger(data[54], data[53]) * 0.1).toFixed(2));
            resistance20_trunk = Number.parseFloat((decodeInteger(data[56], data[55]) * 0.1).toFixed(2));
            resistance100_trunk = Number.parseFloat((decodeInteger(data[58], data[57]) * 0.1).toFixed(2));
            this.log('isStoreData', this.isStoreData);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.bleNative.readBleCharacteristicValue(this.bleDevice.deviceId, UUID_WEIGHT_SERVICES$1, UUID_WEIGHT_READ$1)];
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , this.bleNative.readBleCharacteristicValue(this.bleDevice.deviceId, UUID_BODY_SERVICES$1, UUID_BODY_READ$1)];
          ...
          case 4:
            ...
            return [4
            /*yield*/
            , this.bleNative.enableNotify(this.bleDevice.deviceId, UUID_WEIGHT_SERVICES$1, UUID_WEIGHT_NOTIFY$1)];
          ...
          case 5:
            ...
            return [4
            /*yield*/
            , this.bleNative.enableNotify(this.bleDevice.deviceId, UUID_BODY_SERVICES$1, UUID_BODY_NOTIFY$1)];
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            this.log('称重结束', scaleData); // @ts-ignore
...
function () {
  ...
  QNEventManager.prototype.dispatch = function (eventName, payload) {
    ...
    targetHandlers === null || targetHandlers === void 0 ? void 0 : targetHandlers.forEach(function (handler) {
      try {
        handler(e);
      } catch (error) {
        // eslint-disable-next-line no-console
...
function () {
  function QNBleDevice(nativeDevice, protocol) {
    ...
    ['mac', 'sn', 'modelId', 'isScreenOn', 'isSupportWifi', 'isWspScale', 'totalUserCount', 'registerUserCount', 'offlineDataCount', 'firmwareVersion', 'scaleVersion', 'wifiVersion', 'scaleInfoByte', 'hardVersion', 'spStandardType', 'spDeviceType'].forEach(function (prop) {
      var _a;
...
var log = function log(errorType) {
  return function logW( // eslint-disable-next-line @typescript-eslint/ban-types
...
function (_super) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!this.config.useSdk) return [3
            /*break*/
            , 3]; // 使用SDK配置，请求获取SDK的配置信息
  ...
  QNBle.prototype.onError = function (err) {// const error = err instanceof QNBleError
    //   ? err
  ...
  QNBle.prototype.getBluetoothAdapterState = function () {
    ...
    return (_a = this.bleNative) === null || _a === void 0 ? void 0 : _a.getBluetoothAdapterState();
  };
  /**
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!(this.config.useSdk && !this.config.sdkConfig)) return [3
            /*break*/
            , 3];
            return [4
            /*yield*/
          ...
          case 3:
            ...
            if (this.protocolManager.hasProtocol(bleDevice.deviceId)) {
              this.log("\u5DF2\u8FDE\u63A5(" + bleDevice.deviceId + ":" + bleDevice.name + ")\u8BBE\u5907\uFF0C\u4E0D\u518D\u8FDE\u63A5"); // throw new QNBleError(QNBleErrorType.ALREADY_CONNECTED);
              // @ts-ignore
            ...
            /*break*/
            , 9];
            if (!(this.config.autoStopDiscovery && this.bleScannerState)) return [3
            /*break*/
            , 6];
  ...
  QNBle.prototype.onBleEnableChange = function (available) {
    ...
    (_b = (_a = this.bleEventListener).onBluetoothEnableChange) === null || _b === void 0 ? void 0 : _b.call(_a, {
      available: available
    });
  };
  ...
  QNBle.prototype.onStartScan = function () {
    ...
    (_b = (_a = this.bleEventListener).onStartDiscoveryDevice) === null || _b === void 0 ? void 0 : _b.call(_a);
  };
  ...
  QNBle.prototype.onStopScan = function () {
    ...
    (_b = (_a = this.bleEventListener).onStopDiscoveryDevice) === null || _b === void 0 ? void 0 : _b.call(_a);
  };
  /**
   * 扫描到设备
   */
  ...
  QNBle.prototype.onDeviceFound = function (nativeDevice) {
    ...
    if (this.protocolManager.hasProtocol(nativeDevice.deviceId)) {
      var bleDevice = this.protocolManager.getProtocol(nativeDevice.deviceId).bleDevice; // 如果广播秤连接了
    ...
    if (ProtocolToUse) {
      var targetDevice_1 = new QNBleDevice(nativeDevice, ProtocolToUse); // 匹配设置的蓝牙显示名称
      ...
      if (this.config.useSdk && this.config.sdkConfig) {
        ...
        if (sdkConfig_1.business_models && sdkConfig_1.business_models.length > 0) {
          ...
          sdkConfig_1.business_models.some(function (model) {
            if (model.internal_model === modelId_1) {
              targetDevice_1.displayName = model.dis_model || sdkConfig_1.business_info.default_model;
            }
          });
        }
      }

      this.log('QNBle:onDeviceFound', '转换过后的 QNBleDevice', targetDevice_1);
      (_b = (_a = this.bleEventListener).onBleDeviceFound) === null || _b === void 0 ? void 0 : _b.call(_a, targetDevice_1);
    }
  };
  /**
   * 蓝牙连接成功的回调
  ...
  QNBle.prototype.callProtocolMethod = function (deviceId, fn, args) {
    ...
    return (_a = protocolImp === null || protocolImp === void 0 ? void 0 : protocolImp[fn]) === null || _a === void 0 ? void 0 : _a.call.apply(_a, __spread([protocolImp], args));
  };
  /**
   * 异步调用设备所使用协议的实例方法
   * @param {string} deviceId
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            protocolImp = this.protocolManager.getProtocol(deviceId);
            if (!(protocolImp && fn in protocolImp)) return [3
            /*break*/
            , 4];
            _b.label = 1;
          ...
          case 4:
            return [2
            /*return*/
            , Promise.reject(new Error("protocol method " + fn + " on deviceId: " + deviceId + " not exist"))];
        }
      });
    });
  };
  ...
  __decorate([log(QNBleErrorType.CREATE_CONNECTION_FAILED), __metadata("design:type", Function), __metadata("design:paramtypes", [QNBleDevice, typeof (_a = typeof T !== "undefined" && T) === "function" ? _a : Object, Object]), __metadata("design:returntype", Promise)], QNBle.prototype, "createBleConnection", null);

  __decorate([log(QNBleErrorType.CLOSE_CONNECTION_FAILED), __metadata("design:type", Function), __metadata("design:paramtypes", [QNBleDevice]), __metadata("design:returntype", Promise)], QNBle.prototype, "closeBleConnection", null);

  __decorate([log(QNBleErrorType.STOP_BLE_FAILED), __metadata("design:type", Function), __metadata("design:paramtypes", []), __metadata("design:returntype", Promise)], QNBle.prototype, "stop", null);

  __decorate([log(QNBleErrorType.FETCH_SDK_INFO_FAILED), __metadata("design:type", Function), __metadata("design:paramtypes", []), __metadata("design:returntype", Promise)], QNBle.prototype, "fetchSdkConfig", null);
...
function (_super) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            if (hasOwnProperty(error, 'code') && [0, -1].includes(error.code)) ; else if (error.code === 10012) {
              // 连接超时
  ...
  QNBleNativeMP.prototype.closeServer = function (server) {
    ...
    return server.stopAdvertising().then(function () {
      return server.close();
    }).then(function () {
      _this.log('关闭蓝牙服务');
    });
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (jsbridge[method]) {
          ...
          (_a = jsbridge[method]) === null || _a === void 0 ? void 0 : _a.call(jsbridge, data, function (res) {
            ...
            if ((result === null || result === void 0 ? void 0 : result.error_code) && (result === null || result === void 0 ? void 0 : result.error_code) !== 0) {
              reject(result);
            } else {
              resolve(result);
            }
...
var generateRegisterListener = function generateRegisterListener(isAndroid, jsbridge) {
  ...
  if (isAndroid) {
    return function (method, fn) {
      ...
      (_a = jsbridge === null || jsbridge === void 0 ? void 0 : jsbridge[method]) === null || _a === void 0 ? void 0 : _a.call(jsbridge, {
        fn: fn
      });
    };
  }
...
function (_super) {
  ...
  function QNBleNativeQN(jsbridge, _a) {
    ...
    console.log("\u5F53\u524D\u84DD\u7259\u5E93\u73AF\u5883\u4E3A: " + (isAndroid ? '安卓' : 'ios'));
    _this.bleState = {
      available: false,
      discovering: false
    };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            this.registerListener('onBLEConnectionStateChange', this.onDeviceConnectStateChange.bind(this));
            this.registerListener('onBLECharacteristicValueChange', this.onDeviceValueChange.bind(this));
            this.registerListener('onBluetoothAdapterStateChange', this.onBluetoothAdapterStateChange.bind(this));
            this.registerListener('onBLEDeviceCharacteristics', this.onBLEDeviceCharacteristics.bind(this));
            _a.label = 1;
  ...
  QNBleNativeQN.prototype.readBleCharacteristicValue = function (deviceId, serviceId, characteristicId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
...
function (_super) {
  ...
  function QNBleNativeMultiPages(jsbridge, _a) {
    ...
    console.log("\u5F53\u524D\u84DD\u7259\u5E93\u73AF\u5883\u4E3A: " + (isAndroid ? '安卓' : 'ios'), jsbridge);
    _this.bleState = {
      available: false,
      discovering: false
    };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            this.registerListener('onBleCharacteristicValueChange', this.onDeviceValueChange.bind(this));
            this.registerListener('onBleAuthorityChange', this.onBluetoothAdapterStateChange.bind(this));
            this.registerListener('onBleConnectionStateChange', this.onBleConnectionStateChange.bind(this));
            _a.label = 1;
          ...
          case 2:
            ...
            if (!(!available && res.bleEnableState === 'uninit')) return [3
            /*break*/
            , 4]; // 定位及蓝牙打开后初始化蓝牙
  ...
  QNBleNativeMultiPages.prototype.enableNotify = function (deviceId, serviceId, characteristicId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  QNBleNativeMultiPages.prototype.readBleCharacteristicValue = function (deviceId, serviceId, characteristicId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        if (characteristicId.length === 4) {
          this.log('读取', characteristicId);
  ...
  QNBleNativeMultiPages.prototype.writeData = function (deviceId, serviceId, characteristicId, cmdData) {
    var arry = new Array();
    cmdData.forEach(function (it) {
      arry.push(it);
    });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            characteristics = characteristicsArray.map(function (v) {
  ...
  function QNMPPlugin(config) {
    return _super.call(this, {
      ...
      config: __assign(__assign({}, config), {
        useSdk: true,
        protocols: [QNBleProtocols.NormalBleScaleProtocol, QNBleProtocols.OneToOneBroadcastScaleProtocol, QNBleProtocols.OneToMultiBroadcastScaleProtocol, QNBleProtocols.WspDualScaleProtocol, QNBleProtocols.HeightWeightScaleProtocol, QNBleProtocols.EightElectrodeScaleProtocol]
      })
    }) || this;
  }
...
export { QNBleBaseScaleProtocol, QNBleCommonExtends, QNBleDevice, QNBleError, QNBleNative, QNBleNativeCommonExtends, QNBleNativeDevice, index as QNBleNatives, QNBleProtocol, QNBleProtocols, consts as QNConsts, QNEvent, QNEventManager, QNEventSystem, QNMPPlugin$1 as QNMESPlugin, QNMPPlugin, QNMultiPagesPlugin, QNProtocolManager, QNScaleBiz, utils as QNUtils };
