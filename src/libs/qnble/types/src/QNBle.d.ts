...
export default class QNBle extends QNEventSystem<QNBle> {
  ...
  protocolManager: QNProtocolManager<
    Partial<QNBleTypings.QNDeviceEventListener>
  >;
  bleServer: unknown;
  ...
  constructor(
    params?: Partial<
      Omit<QNBleTypings.QNBleCommonConstructorParams, 'bleDevice'>
    >
  );
  log(...params: any[]): void;
  /**
