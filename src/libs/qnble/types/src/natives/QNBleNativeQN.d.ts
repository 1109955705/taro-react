...
export default class QNBleNativeQN extends QNBleNativeCommonExtends implements QNBleNative {
    name: string;
    jsbridge: any;
    ...
    findBleDeviceCharacteristics(deviceId: string, serviceId: string): Promise<any>;
