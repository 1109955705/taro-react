...
declare namespace QNBleTypings {
  ...
  interface QNBleNativeEventListener {
    ...
    onNativeCharacteristicValueChange: (
      payload: TypedCharacteristicValueChangePayload
    ) => void;
  ...
  namespace QNDeviceEventListener {
    type onGetDeviceInfo = (
      e: QNEvent<TypedProtocolDeviceInfo<object>>
    ) => void;
  ...
  interface QNHeightScaleEventListener extends QNDeviceEventListener {
     ...
     */
    onGetDeviceInfo: (
      payload: TypedProtocolDeviceInfo<{
        fwVersion: number;
        bleVersion: number;
      }>
    ) => void;
     ...
     * 获取到非稳定重量
     */
    onGetUnsteadyWeight: (payload: { weight: number }) => void;
    /**
     * 获取到非稳定身高
     */
    onGetUnsteadyHeight: (payload: { height: number }) => void;
    /**
     * 获取到稳定身高和体重
     */
    onMeasureHeightEnd: (payload: { weight: number; height: number }) => void;
    /**
     * 获取到秤端数据
     */
   ...
   * 带wifi功能的秤的回调方法
   */
  interface QNWifiScaleScaleMeasureEventListener
    extends QNBaseScaleMeasureEventListener {
    /**
     * 回调配网结果
     */
  ...
  interface QNWspDualScaleMeasureEventListener
    extends QNWifiScaleScaleMeasureEventListener {
    /**
     * 回调注册用户结果
     */
     ...
     */
    onGetVisitUserResult: (payload: { isSuccess: boolean }) => void;
    /**
     * 获取到删除用户的结果
     */
    onGetDeleteUserResult: (payload: { isSuccess: boolean }) => void;
    /**
     * 获取存储的历史数据
     */
  ...
  interface QNMesEventLisenter extends QNDeviceEventListener {
     ...
     * 读取到了SN
     */
    onGetSnCode: (paylod: { sn: string }) => void;
    onModuleTestWriteSnState: (payload: { isSuccess: boolean }) => void;
    onModuleTestWeightData: (payload: { weight: number }) => void;
    onModuleTestHeightData: (payload: { height: number }) => void;
    onModuleTestResistanceData: (payload: TypeOriginScaleData) => void;
    onModuleTestCodeStatus: (payload: { isSuccess: boolean }) => void;
     ...
     * 获取到标定结果状态
     */
    onCalibrationCodeStatus: (payload: { isSuccess: boolean }) => void;
    /**
     * 获取到非稳定重量
     */
    onGetUnsteadyWeight: (payload: { weight: number }) => void;
     ...
     * 获取到回检重量
     */
    onGetReviewWeightData: (payload: { weight: number }) => void;
    /**
     * 收到回检标示保存结果
     */
    onReviewCodeStatus: (payload: { isSuccess: boolean }) => void;
    /**
     * 收到偏载重量
     */
    onGetPartialWeightData: (payload: { weight: number }) => void;
    /**
     * 设置偏载是否成功
     */
    onPartialCodeStatus: (payload: { isSuccess: boolean }) => void;
    /**
     * 收到非稳定的身高或体重
     */
     ...
     * 设置选型是否成功
     */
    onGetWriteModelIdResult: (payload: { isSuccess: boolean }) => void;
    /**
     * 获取到wifi结果
     */
    onGetWifiResult: (payload: { isSuccess: boolean }) => void;
    /**
     * 设备状态变化
     */
    onDeviceStateChange: (payload: { behavior: string }) => void;
  }
  ...
  interface QNSPMeasureEventListener extends QNDeviceEventListener {
    onGetDeviceInfo: (
      payload: TypedProtocolDeviceInfo<TypedSpProtocolDeviceInfo>
    ) => void;
  ...
  interface QNThermoMeasureEventListener extends QNDeviceEventListener {
    onGetDeviceInfo: (
      payload: TypedProtocolDeviceInfo<TypedThermoProtocolDeviceInfo>
    ) => void;
  ...
  type TypedProtocolMethodCallback<
    T extends TypedProtocolMethodCallbackRetValue
  > = (
    arg0: T,
    data: QNBleTypings.TypedCharacteristicValueChangePayload,
    protocolImp: QNBleProtocol<QNDeviceEventListener>
  ) => any;
}
