...
export default class WspDualScaleMesProfle implements QNBleProtocolProfile {
    ...
    buildProduceTargetDevice(nativeDevice: QNBleNativeDevice): Partial<QNBleDevice>;
    /**
     * 成品设备
     */
    buildProductTargetDevice(nativeDevice: QNBleNativeDevice): Partial<QNBleDevice>;
}
