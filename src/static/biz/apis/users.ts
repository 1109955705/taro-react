...
export const ApiLogin: TypedApiScheme = {
  ...
  responseMock: {
    ...
    agent_info: {
      ...
      code: '200',
      terminal_user_session:
        'HjJzKmsllmptnrf7JDDAXUBJObc1v4ZVCmLHVbpLiLvacnM-_iURxf8r0kcB4ZspvhL7tW8v4pTJ7GP0qyRZK8eQEM0OsvkNHkgUJ12VPJflnbCPrP1iMBmVJaTJFlCtfwVhVjh8zxPPrWvQXgHgAyqpxE7JSA6n1kwhKi1YSpQ',
      user_info: {
        account_name: '不不不',
        adviser_user_id: 0,
